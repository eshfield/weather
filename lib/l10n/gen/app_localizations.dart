...
abstract class AppLocalizations {
  ...
  /// No description provided for @unknownLocalName.
  ///
  /// In en, this message translates to:
  /// **'Location name unknown'**
  String get unknownLocalName;
  ...
  ///
  /// In en, this message translates to:
  /// **'Data is provided by the OpenWeather service'**
  String get footer;
  ...
  ///
  /// In en, this message translates to:
  /// **'Check you internet connection and/or try again later'**
  String get loadingErrorText;

  /// No description provided for @locatingError.
  ///
  /// In en, this message translates to:
  /// **'Getting location error'**
  String get locatingError;
